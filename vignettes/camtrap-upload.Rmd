...
DBI::dbExecute(conn = con_odbc, paste(SQL("CREATE VIEW test.curated_camtrap_records AS"), records_curated_view(con_odbc)))
DBI::dbExecute(conn = con_odbc, paste(SQL("CREATE VIEW test.curated_camtrap_operation AS"), operation_curated_view(con_odbc)))
DBI::dbExecute(conn = con_odbc, paste(SQL("CREATE VIEW test.curated_project_information AS"), project_curated_view(con_odbc)))

DBI::dbExecute(conn = con_odbc, paste(SQL("CREATE VIEW test.processed_site_substation_presence_absence AS"), processed_SubStation_presence_absence(con = con_odbc, return_data = FALSE)))

DBI::dbExecute(conn = con_odbc, paste(SQL("CREATE VIEW test.processed_site_substation_daily_presence_absence AS"), processed_SubStation_presence_absence(con = con_odbc, daily = TRUE, return_data = FALSE)))
```
